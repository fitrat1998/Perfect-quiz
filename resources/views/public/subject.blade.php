   ...
   <div class="row">
            ...
            <div class="row">
               ...
               <div class="col-md-3">
                  <div class="card p-1 ">
                     <span class="logo_s_text">
                        ...
                        <div class="textSubjectName">
                           <b class="h4">Oliy matematika</b>
               ...
               <div class="col-md-3">
                  <div class="card p-1 ">
                     <span class="logo_s_text">
                        <svg class="m-2 subject_icon_background p-2" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28" fill="none">
               ...
               <div class="col-md-3">
                  <div class="card p-1 ">
                     <span class="logo_s_text">
                        <img class="m-2 subject_icon_background p-2" src="{{ asset('img/svg/coding.svg') }}" width="19" height="16" >
                        </svg>
                        <div class="textSubjectName">
                           <b class="h4">Dasturlash</b>
                           <p class="subject_user_text">Polatov T</p>
                        </div>
                     </span>
                  </div>
