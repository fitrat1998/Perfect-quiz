                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="h-100">
                                ...
                                <div class="row">
                                    <!-- Dark Variant -->
                                    <div class="card radius-5" style="border-radius: 24px;background: #4062FF;box-shadow: 0px 0px 40px 0px rgba(48, 73, 191, 0.04);">
                                         <!-- <div class="col-md-8">
                                            <div class="row"> -->
                                    ...
                                    <div class="col-md-3">
                                        <div class="card p-1 ">
                                            <span class="logo_s_text"><svg class="m-2 subject_icon_background p-2" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28" fill="none">
                                                ...
                                                <div class="textSubjectName"><b class="h4">Asalom alekum</b><p class="subject_user_text">O'qituvchi nomi</p></div>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
